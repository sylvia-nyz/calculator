    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_equal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(i==0 && j==1) {//二进制转八进制
                    m = Integer.parseInt(wantonlyConversion(st,2));//二进制转十进制
                    val = Integer.toOctalString(m);//转八进制
                    tv2.setText(val);
                }
                ...
                if(i==0 && j==3) {//二进制转十六进制
                    m = Integer.parseInt(wantonlyConversion(st,2));//二进制转十进制
                    val = Integer.toHexString(m);//转十六进制
                    tv2.setText(val);
                }

                if(i==1 && j==0) {//八进制转二进制
                    m = Integer.parseInt(wantonlyConversion(st,8));//八进制转十进制
                    val = Integer.toBinaryString(m);//转二进制
                    tv2.setText(val);
                }
                ...
                if(i==1 && j==3) {//八进制转十六进制
                    m = Integer.parseInt(wantonlyConversion(st,8));//八进制转十进制
                    val = Integer.toHexString(m);//转十进制
                    tv2.setText(val);
                }
                ...
                if(i==3 && j==0) {//十六进制转二进制
                    m = Integer.parseInt(wantonlyConversion(st,16));//十六进制转十进制
                    val = Integer.toBinaryString(m);//转二进制
                    tv2.setText(val);
                }
